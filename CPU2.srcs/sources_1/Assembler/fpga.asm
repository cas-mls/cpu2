...
BETEST1:
    add r tr, #1
    bne r1, r2, [BRCOMPMEM] ; FALSE [r1 = r2] - No Branch
    add r tr, #1
    be r1, r2, [BETESTMEM]  ; TRUE [r1 = r2] - Branch Memory
    jmp BRERR
BLTESTNE:
    add r tr, #1
...
BLTEST1:
    add r tr, #1
    bge r3, r1, [BLTESTMEM]  ; TRUE [r3 < r1] - Branch Memory
    add r tr, #1
    blt r3, r1, [BLTESTMEM]  ; TRUE [r3 < r1] - Branch Memory
    noop
BGTESTNE:
    add r tr, #1
...
BGTEST1:
    add r tr, #1
    bgt r4, r1, [BGTEST2MEM]  ; TRUE [r4 > r1] - Branch Memory
    jmp BRERR
    noop
BGTEST2:
    add r tr, #1
...
BEZEROTEST:
    add r tr, #1
    bne r1, [BR2COMPMEM] ; FALSE [r1 = r2] - No Branch
    add r tr, #1
    be r1, [BZTESTMEM]  ; TRUE [r1 = r2] - Branch Memory
    jmp BRERR
BNTESTNE:
    add r tr, #1
...
BNTEST1:
    add r tr, #1
    bge r3, [BNTESTMEM]  ; FALSE [r3 < 0] - Branch Memory
    add r tr, #1
    blt r3, [BNTESTMEM]  ; TRUE [r3 < 0] - Branch Memory
    noop
BPTESTNE:
    add r tr, #1
...
BPTEST1:
    add r tr, #1
    bgt r4, r1, [BPTEST2MEM]  ; TRUE [r4 > r1] - Branch Memory
    jmp BRERR
    noop
BPTEST2:
    add r tr, #1
